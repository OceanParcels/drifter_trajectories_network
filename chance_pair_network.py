...
drifter_trajectory_data = 'drifter_data_north_atlantic/uniformized_dataset_365days_1deg_uniform.npz'
matrix_file = "analysis_output/M_minimum_distances_uniformized_dataset_365days_1deg_uniform.npy"
...
def construct_M():
    ...
    drifter_data.plot_initial_position(ax1, indices)
    plt.show()
